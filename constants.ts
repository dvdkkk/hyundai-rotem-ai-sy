...
export const COURSES: Course[] = [
  {
    ...
    type: 'engineer',
    title: '현대로템 K-방산 SMART AI모델 개발과정',
    subTitle: '확장성과 안정성을 구축하는 인프라 전문가 과정',
    description: '100% 오프라인 수업으로 진행되는 현대로템 K-방산 SMART AI모델 개발과정입니다. 리눅스, 네트워크, 데이터베이스, 쿠버네티스, AWS, 오픈스택 등 클라우드 인프라의 핵심 기술을 마스터합니다.',
    duration: '26.08.12 ~ 27.02.16(6개월)',
    schedule: '26.08.12 ~ 27.02.16(6개월)',
    classTime: '평일 09:30~18:30 (1일 8시간)',
    capacity: '26명',
    locations: '에이콘아카데미(강남) 본원',
    selfPay: '0~50만원 (17,424,000원 정부지원) 지원 유형에 따라 자비 부담금 발생 또는 전부 지원',
    trainingAllowance: '매월 30만원 + a 국민취업지원제도 1유형시 시 60만원 추가 지급',
